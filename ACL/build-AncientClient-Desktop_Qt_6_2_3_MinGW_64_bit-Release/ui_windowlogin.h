...
public:
    ...
    void setupUi(QDialog *WindowLogIn)
    {
        ...
        banner_2->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 85,65%);\n"
"border-style: solid;\n"
"border-width: 2px;\n"
"border-radius: 10px;\n"
...
"background-color: rgba(255, 0, 0,80%);"));
    ...
    void retranslateUi(QDialog *WindowLogIn)
    {
        ...
        banner_2->setText(QCoreApplication::translate("WindowLogIn", "Minim 8 caractere ambele, fara spatii", nullptr));
