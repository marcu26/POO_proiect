...
"color: rgb(255,255,255);"));
        ...
        labelFara = new QLabel(widget);
        labelFara->setObjectName(QString::fromUtf8("labelFara"));
        labelFara->setGeometry(QRect(70, 470, 321, 31));
        labelFara->setStyleSheet(QString::fromUtf8("background-color: rgba(85, 0, 0,80%);\n"
"color:rgb(255,255,255);"));
        labelFara->setAlignment(Qt::AlignCenter);
        player = new QLabel(widget);
        player->setObjectName(QString::fromUtf8("player"));
        player->setGeometry(QRect(70, 510, 221, 31));
...
"border-radius: 10px;"));
    ...
    void retranslateUi(QDialog *windowAttack)
    {
        ...
        labelFara->setText(QCoreApplication::translate("windowAttack", "Nu mai ai trupe din categoria ", nullptr));
        player->setText(QCoreApplication::translate("windowAttack", "User:", nullptr));
    } // retranslateUi
