...
"border-radius: 10px;"));
        ...
        banner_2 = new QLabel(widget);
        banner_2->setObjectName(QString::fromUtf8("banner_2"));
        banner_2->setGeometry(QRect(290, 140, 400, 40));
        banner_2->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 85,60%);\n"
"border-style: solid;\n"
"border-width: 2px;\n"
"border-radius: 10px;"));
    ...
    void retranslateUi(QDialog *WindowSingIn)
    {
        ...
        succes->setText(QCoreApplication::translate("WindowSingIn", "Inregistrare cu succes", nullptr));
        ...
        banner_2->setText(QCoreApplication::translate("WindowSingIn", "Minim 8 caractere ambele, fara spatii", nullptr));
    } // retranslateUi
