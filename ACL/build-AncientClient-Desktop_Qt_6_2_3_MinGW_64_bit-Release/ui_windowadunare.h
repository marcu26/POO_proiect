...
"border-color:black"));
        ...
        sold->setGeometry(QRect(60, 300, 121, 20));
...
"background-color: rgba(0, 0, 0,80%);"));
        ...
        sold_2->setGeometry(QRect(60, 440, 121, 20));
...
"border-color:black"));
        ...
        sold_3->setGeometry(QRect(60, 370, 121, 20));
...
"background-color: rgb(255, 0, 0);"));
        ...
        players = new QLabel(widget);
        players->setObjectName(QString::fromUtf8("players"));
        players->setGeometry(QRect(530, 530, 221, 31));
        players->setStyleSheet(QString::fromUtf8("color:rgb(255, 255, 255);\n"
"background-color: rgb(255, 0, 0);"));
        players->setAlignment(Qt::AlignCenter);
        player = new QLabel(widget);
        player->setObjectName(QString::fromUtf8("player"));
        player->setGeometry(QRect(20, 530, 221, 31));
        player->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0,80%);\n"
"border-style: solid;\n"
"border-width: 2px;\n"
"border-radius: 10px;"));
        player->setAlignment(Qt::AlignCenter);
        nrSold = new QLabel(widget);
        nrSold->setObjectName(QString::fromUtf8("nrSold"));
        nrSold->setGeometry(QRect(190, 280, 41, 41));
        nrSold->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0,80%);\n"
""));
        nrCav = new QLabel(widget);
        nrCav->setObjectName(QString::fromUtf8("nrCav"));
        nrCav->setGeometry(QRect(190, 350, 41, 41));
        nrCav->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0,80%);\n"
""));
        nrMed = new QLabel(widget);
        nrMed->setObjectName(QString::fromUtf8("nrMed"));
        nrMed->setGeometry(QRect(190, 420, 41, 41));
        nrMed->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0,80%);\n"
""));
        listWidget = new QListWidget(widget);
        listWidget->setObjectName(QString::fromUtf8("listWidget"));
        listWidget->setGeometry(QRect(120, 160, 261, 361));
...
"border-radius: 10px;"));
        ...
        wins->setObjectName(QString::fromUtf8("wins"));
        wins->setGeometry(QRect(330, 510, 161, 31));
        wins->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0,80%);"));
        wins->setAlignment(Qt::AlignCenter);
        loses = new QLabel(widget);
        loses->setObjectName(QString::fromUtf8("loses"));
        loses->setGeometry(QRect(330, 550, 161, 31));
...
"background-color: rgba(0, 0, 0,80%);"));
    ...
    void retranslateUi(QDialog *windowAdunare)
    {
        ...
        players->setText(QCoreApplication::translate("windowAdunare", "Nu exista jucatori connectati", nullptr));
        player->setText(QCoreApplication::translate("windowAdunare", "User:", nullptr));
        nrSold->setText(QCoreApplication::translate("windowAdunare", "Nr: 0", nullptr));
        nrCav->setText(QCoreApplication::translate("windowAdunare", "Nr: 0", nullptr));
        nrMed->setText(QCoreApplication::translate("windowAdunare", "Nr: 0", nullptr));
        wins->setText(QCoreApplication::translate("windowAdunare", "Wins:", nullptr));
        loses->setText(QCoreApplication::translate("windowAdunare", "Loses:", nullptr));
    } // retranslateUi
